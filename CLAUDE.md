...
- **Rust tests**:39 crates / **567 passed / 0 failed**(v4.7 後;v4.4 baseline 528 → +39 v4.5+v4.6+v4.7 tests across 8 sub-PR commits)
...
- **v4.5 + v4.6 + v4.7**(2026-05-19):M3SPEC 闕漏補完 8 sub-PR 完整收尾 ☕ — Group 2(4 sub-PR corrective triggers + emulation)+ Group 3(Monowave bar_indices + m1_endpoint_broken_by_m2 real impl)+ Group 1(3 sub-PR polywave 嵌套依賴鏈);全市場 1266 stocks P0 Gate **全綠**(forest_size:max=196 / p95=28 / overflow=0 / wall time 648s)
