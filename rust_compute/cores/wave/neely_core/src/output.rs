...
// P1-1:OhlcvSeries / OhlcvBar 下放 fact_schema(解除 ohlcv_loader → neely_core
// 反向依賴);本處 re-export 維持 `neely_core::output::OhlcvSeries` 既有路徑。
...
pub struct MonowaveStructureLabels {
    ...
    pub pass1_only_labels: Vec<StructureLabelCandidate>,
}
