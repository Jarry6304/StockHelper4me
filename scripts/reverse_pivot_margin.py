"""
reverse_pivot_margin.py
=======================
PR #18:margin_daily(v2.0)→ margin_purchase_short_sale_tw(v3.2 Bronze)。

16 raw FinMind 欄位:6 stored + 8 detail JSONB key(融資三+融券三+offset/note)。
