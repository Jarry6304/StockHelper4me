"""
reverse_pivot_day_trading.py
============================
PR #18:day_trading(v2.0)→ day_trading_tw(v3.2 Bronze)。

4 raw FinMind 欄位:2 stored(day_trading_buy/sell)+ 2 detail JSONB key
(day_trading_flag、volume)。row 比:legacy N → Bronze N(1:1)。
