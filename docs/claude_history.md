...
# CLAUDE.md v1.10 ~ v1.34 歷史(從 v3.18 整理時抽出)

> **時間範圍**:2026-05-02 → 2026-05-14
> **內容**:m2 PR sequencing(PR #18 reverse-pivot → PR #21 deprecated cleanup → PR #22 TAIEX OHLCV → M3 PR-1 ~ PR-9a tw_cores 全市場全核 dispatch → 9 阻塞拍版 + Round 1-4 收尾)+ P1/P2/P3 cores batch + Aggregation Layer 4 Phase 完整落地 + v1.34 P0 Gate v3/v4 production 校準。
> **對應主檔版本**:CLAUDE.md v3.18 之後
> **參考時機**:動工 m2 大重構或 M3 Cores 早期 PR 細節 / 找 Round 1-4 calibration 設計理由 / 看 9 阻塞拍版邏輯時。
