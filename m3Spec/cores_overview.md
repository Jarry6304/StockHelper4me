...
|---|---|---|
| `_market_` | 台股整體市場 | `market_margin_core` |
| `_global_` | 跨市場 / 全球環境變數 | `us_market_core` / `exchange_rate_core` / `fear_greed_core` |
| `_index_taiex_` | 加權指數本身 | `taiex_core` |
