...
pub struct NeelyCoreOutput {
    ...
    // === 元資料 ===
    pub source_version: String,                 // "neely_core 1.0.0"
    pub params_hash: String,
    pub computed_at: DateTime<Utc>,

    // === 失敗旗標(Hybrid 失敗模型)===
    pub insufficient_data: bool,                // 規則失敗:資料不足
    pub compaction_timeout: bool,               // 規則失敗:Compaction 逾時
}
...
| 1-3 年 | Minuette / Minute | 中期結構可識別 |
| 3-10 年 | Minor / Intermediate | 大級別需要更長歷史 |
| 10-30 年 | Primary | Cycle 級需歷史 30+ 年 |
| > 30 年 | Cycle / Supercycle | TAIEX、加權指數歷史夠用 |
